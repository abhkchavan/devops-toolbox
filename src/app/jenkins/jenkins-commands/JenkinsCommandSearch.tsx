...
type JenkinsSection = {
  title: string;
  commands: JenkinsCommand[];
};

type Props = {
  sections: JenkinsSection[];
};
  ...
  return (
    <div className="mb-10">
          ...
          <div className="flex items-end justify-between gap-4">
            <div>
              <h2 className="text-2xl font-bold text-white">
                Jenkins Command Categories
              </h2>

              <p className="mt-2 text-sm leading-6 text-slate-400">
                Jump directly to the Jenkins commands you need.
              </p>
            </div>
      ...
      <section className="mt-10 rounded-xl border border-slate-800 bg-slate-900 p-5">
        <label
          htmlFor="jenkins-search"
          className="text-sm font-semibold text-slate-300"
        >
          Search Jenkins commands
        </label>
        ...
        <div className="mt-3 flex flex-col gap-3 sm:flex-row">
          <input
            ...
            placeholder="Search jobs, builds, pipelines, agents, plugins, credentials..."
