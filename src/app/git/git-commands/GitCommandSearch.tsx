    ...
    <>
      <section className="mt-10 rounded-xl border border-slate-800 bg-slate-900 p-5">
        ...
        <input
          ...
          placeholder="Search commits, branches, merge, rebase, stash..."
      ...
      {search && filteredSections.length === 0 ? (
        <section className="mt-8 rounded-xl border border-slate-800 bg-slate-900 p-8 text-center">
          ...
          <p className="mt-3 text-slate-400">
            Try searching for commits, branches, push, pull, merge, rebase,
            stash, reset, revert, tags or troubleshooting.
          </p>
        </section>
      ) : (
