...
return (
<> <section className="mt-10 rounded-xl border border-slate-800 bg-slate-900 p-5"> <label
       htmlFor="kubectl-search"
       className="text-sm font-semibold text-slate-300"
     >
Search kubectl commands </label>
...
```
    <div className="relative mt-3">
      <input
        ...
        placeholder="Search pods, logs, deployments, RBAC, storage, networking..."
  ...
  {query && filteredSections.length === 0 ? (
    <section className="mt-8 rounded-xl border border-slate-800 bg-slate-900 p-8 text-center">
      ...
      <p className="mt-3 leading-7 text-slate-400">
        Try searching for pods, logs, deployments, services, namespaces,
        rollouts, RBAC, storage, networking, Ingress, Jobs, CronJobs,
        ConfigMaps, Secrets, debugging or troubleshooting.
      </p>
