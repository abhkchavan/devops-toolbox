...
return ( <main className="min-h-screen bg-slate-950 px-6 py-12 text-white"> <div className="mx-auto max-w-5xl"> <a
       href="/"
       className="text-sm text-cyan-400 hover:underline"
     >
{"\u2190"} Back to DevOpsToolbox </a>
...
kubectl describe node <node-name>`} </pre> </div>
