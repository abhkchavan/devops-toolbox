    ...
    commands: [
      {
        command: "uname -a",
        description:
          "Display detailed Linux kernel and system information.",
      },
      {
        command: "hostname",
      ...
      },
      {
        command: "hostnamectl",
        description:
          "Display or manage hostname and operating system information.",
      },
      {
        command: "uptime",
        description:
      ...
      },
      {
        command: "timedatectl",
        description:
          "Display system time, timezone and time synchronization information.",
      },
      {
        command: "lsb_release -a",
        description:
          "Display Linux distribution information on systems that provide lsb_release.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "Create a directory structure including missing parent directories.",
      },
      {
      ...
      },
      {
        command: "rm -rf app",
        description:
          "Forcefully remove a directory and its contents. Use carefully.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Display detailed file metadata such as permissions, size and timestamps.",
      },
    ],
  },
  {
    ...
    commands: [
      {
        command: "ls -l",
        description:
          "View file permissions, ownership and other metadata.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Recursively change permissions under a directory.",
      },
      {
      ...
      },
      {
        command: "umask",
        description:
          "Display the current default permission mask for newly created files.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "View local user account information.",
      },
      {
        command: "cat /etc/group",
        description:
          "View local group information.",
      },
      {
        command: "sudo -l",
        description:
          "Show commands the current user is allowed to run with sudo.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Add a user to an additional group without removing existing memberships.",
      },
      {
    ...
    commands: [
      {
        command: "ps aux",
        description:
          "Display running processes for all users.",
      },
      {
        command: "ps -ef",
        description:
          "Display processes using the full-format listing.",
      },
      {
        command: "top",
        description:
          "Interactively monitor running processes and system resources.",
      },
      {
        command: "htop",
        description:
          "Interactive process viewer with a more user-friendly interface when installed.",
      },
      {
        command: "pgrep nginx",
        description:
          "Find process IDs matching a process name or pattern.",
      },
      {
        command: "pkill nginx",
        description:
          "Send a signal to processes matching a name or pattern.",
      },
      {
        command: "kill <PID>",
        description:
          "Send the default termination signal to a process.",
      },
      {
        command: "kill -9 <PID>",
        description:
          "Forcefully terminate a process when normal termination does not work.",
      },
      {
        command: "jobs",
        description:
      ...
      },
      {
        command: "bg",
        description:
          "Resume a stopped shell job in the background.",
      },
      {
        command: "fg",
        description:
          "Bring a background shell job to the foreground.",
      },
      {
        command: "nohup ./app.sh &",
        description:
          "Run a command so it can continue after the terminal session ends.",
      },
    ],
  },
  {
    ...
    commands: [
      {
        command: "df -h",
        description:
          "Check filesystem disk usage in human-readable format.",
      },
      {
        command: "df -i",
        description:
      ...
      },
      {
        command: "du -sh *",
        description:
          "Show the size of items in the current directory.",
      },
      {
        command: "du -ah /var/log | sort -h",
        description:
          "Find large files and directories by sorting disk usage.",
      },
      {
        command: "lsblk",
        description:
      ...
      },
      {
        command: "findmnt",
        description:
          "Display mounted filesystems in a structured view.",
      },
      {
        command: "free -h",
        description:
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        command: "ss -tulpn",
        description:
          "Show listening TCP and UDP sockets with process information when permitted.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Fetch HTTP response headers without downloading the full body.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Query DNS records when the dig utility is installed.",
      },
      {
        command: "nslookup example.com",
        description:
          "Query DNS information for a hostname.",
      },
      {
        command: "traceroute example.com",
        description:
          "Trace the network path to a destination when traceroute is installed.",
      },
    ],
  },
  {
    ...
    commands: [
      {
        command: "apt update",
        description:
          "Refresh package information on Debian and Ubuntu systems.",
      },
      {
        command: "apt upgrade",
        description:
          "Upgrade installed packages on Debian and Ubuntu systems.",
      },
      {
        command: "apt install nginx",
        description:
          "Install a package on Debian and Ubuntu systems.",
      },
      {
        command: "apt remove nginx",
        description:
          "Remove a package on Debian and Ubuntu systems.",
      },
      {
        command: "dnf install nginx",
        description:
          "Install a package on Fedora, RHEL-compatible and other DNF-based systems.",
      },
      {
        command: "dnf update",
        description:
          "Update packages on DNF-based systems.",
      },
      {
        command: "yum install nginx",
        description:
          "Install a package on older or compatible YUM-based systems.",
      },
      {
        command: "which nginx",
        description:
          "Show the executable path for a command when it is available in PATH.",
      },
      {
        command: "command -v nginx",
        description:
          "Check whether a command is available and show its resolved location.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "Reload a service configuration without fully restarting the service when supported.",
      },
      {
        command: "systemctl enable nginx",
        description:
          "Configure a service to start automatically during boot.",
      },
      {
      ...
      },
      {
        ...
        description:
          "List loaded systemd service units.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "Follow new log entries for a systemd service.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Continuously monitor new entries in an application log.",
      },
      {
        command: "grep 'ERROR' app.log",
        description:
          "Search a log file for lines containing ERROR.",
      },
      {
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "Read a large file interactively page by page.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Extract the first colon-separated field from each line.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Replace text using sed without modifying the original file by default.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "Recursively search files under a directory for ERROR.",
      },
      {
        command: "grep -n 'ERROR' app.log",
        description:
          "Show matching lines together with their line numbers.",
      },
      {
        command: "locate nginx.conf",
        description:
          "Quickly search an indexed file database when locate is installed and its database is available.",
      },
      {
        command: "which docker",
        description:
          "Find the executable path for Docker if it is available in PATH.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "Connect to SSH using a custom port.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Copy a local file to a remote server using SSH.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Synchronize files efficiently with a remote server.",
      },
      {
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description:
          "Reload shell configuration into the current shell.",
      },
      {
        command: "history",
        description:
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        command: "crontab -r",
        description:
          "Remove the current user's cron table. Use carefully.",
      },
      {
        command: "systemctl list-timers",
        description:
          "List systemd timers configured on the system.",
      },
      {
        command: "date",
        description:
          "Check the current server date and time before troubleshooting scheduled tasks.",
      },
    ],
  },
  {
    ...
    commands: [
      ...
      },
      {
        command: "vmstat 1",
        description:
          "Display system performance statistics at regular intervals.",
      },
      {
        command: "iostat",
        description:
          "Display CPU and I/O statistics when sysstat is installed.",
      },
      {
        command: "uptime",
        description:
          "Display load averages and system uptime.",
      },
      {
        command: "df -h",
        description:
      ...
      },
      {
        command: "du -sh *",
        description:
          "Identify large files and directories in the current location.",
      },
    ],
  },
  {
    ...
    commands: [
      {
        ...
        description:
          "Repeatedly run a command at a fixed interval when watch is available.",
      },
      {
        command: "history | grep docker",
        description:
          "Search shell history for previously used Docker commands.",
      },
      {
        command: "curl -I http://localhost:8080",
        description:
          "Quickly check HTTP response headers from a local application.",
      },
      {
        command: "ss -lntp",
        description:
          "Check listening TCP ports and associated processes when permitted.",
      },
      {
        command: "ps aux --sort=-%cpu | head",
        description:
          "Show processes consuming the most CPU.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Sort filesystem usage to help identify heavily used filesystems.",
      },
      {
        command: "grep -R 'connection refused' /var/log",
        description:
          "Search logs for a common service connectivity error.",
      },
    ],
  },
  {
    ...
    commands: [
      {
        command: "df -h",
        description:
          "Check whether a full filesystem is causing application failures.",
      },
      {
        command: "free -h",
        description:
          "Check whether memory or swap pressure is present.",
      },
      {
        command: "top",
        description:
      ...
      },
      {
        command: "ss -tulpn",
        description:
          "Check listening ports and network services.",
      },
      {
      ...
      },
      {
        ...
        description:
          "View error-level journal messages from the current boot.",
      },
      {
        command: "dmesg -T | tail -n 50",
        description:
          "Inspect recent kernel messages with human-readable timestamps.",
      },
    ],
  },
];
