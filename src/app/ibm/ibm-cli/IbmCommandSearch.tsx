...
export default function IbmCommandSearch({ sections }: Props) {
  ...
  const filteredSections = useMemo(() => {
    ...
    return sections
      ...
      .filter(
        (section): section is IbmSection => section !== null,
      );
  }, [query, sections]);
        ...
        <section className="mb-10">
          <div className="mb-5">
            <h2 className="text-2xl font-bold text-white">
              IBM Cloud CLI Command Categories
            </h2>

            <p className="mt-2 text-slate-400">
              Jump directly to the IBM Cloud commands you need.
            </p>
          </div>
            ...
            {sections.map((section) => (
              ...
              >
                ...
                <p className="mt-3 text-sm leading-6 text-slate-400">
                  IBM Cloud commands for {section.title.toLowerCase()}.
                </p>
