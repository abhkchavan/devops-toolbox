...
```
  ...
  {query && filteredSections.length === 0 ? (
    <section className="mt-8 rounded-xl border border-slate-800 bg-slate-900 p-8 text-center">
      <h2 className="text-xl font-bold text-white">No commands found</h2>

      <p className="mt-3 leading-7 text-slate-400">
        Try searching for containers, images, builds, networks, volumes,
        Compose, Dockerfile, BuildKit, contexts, registries, resources,
        health checks or troubleshooting.
      </p>
