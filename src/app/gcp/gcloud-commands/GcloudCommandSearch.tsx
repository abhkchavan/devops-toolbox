...
<> <section className="mt-10 rounded-xl border border-slate-800 bg-slate-900 p-5"> <label
     ...
     >
Search Google Cloud CLI commands </label>
  ...
  {query && filteredSections.length === 0 ? (
    <section className="mt-8 rounded-xl border border-slate-800 bg-slate-900 p-8 text-center">
      ...
      <p className="mt-3 leading-7 text-slate-400">
        Try searching for Compute Engine, Storage, VPC, GKE, Artifact
        Registry, Cloud Run, Cloud SQL, IAM, DNS, Monitoring, Logging,
        Secret Manager, BigQuery, APIs or troubleshooting.
      </p>
